...
import { ContractSearchResult } from "src/app/contracts/model/contract-search-Result";
...
import { ContractService } from "src/app/contracts/service/contract.service";
...
@Component({
  selector: "app-bp-contracts",
  templateUrl: "./bp-contracts.component.html",
  styleUrl: "./bp-contracts.component.scss",
})
export class BpContractsComponent {
